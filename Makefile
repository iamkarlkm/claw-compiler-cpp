...
TEST_DEBUGGER_SOURCES = src/debugger/claw_debugger.cpp src/test/test_debugger.cpp
TEST_AUTO_SCHEDULER_SOURCES = src/auto_scheduler/auto_scheduler.cpp src/auto_scheduler/vm_evaluator.cpp src/auto_scheduler/ml_evaluator.cpp \
    ...
    src/auto_scheduler/search_strategy.cpp src/test/test_auto_scheduler.cpp
TEST_VM_EVALUATOR_SOURCES = src/auto_scheduler/vm_evaluator.cpp src/auto_scheduler/schedule_space.cpp \
    ...
    src/pipeline/perf_profiler.cpp \
    src/tensorir/tensor_ir.cpp src/test/test_vm_evaluator.cpp
TEST_TENSORIR_SOURCES = src/tensorir/tensor_ir.cpp src/test/test_tensor_ir.cpp
...
.PHONY: all clean test help \
    ...
    test-auto-scheduler test-tensorir test-wasm test-attribute test-docgen test-vm-evaluator
...
help:
	...
	@echo "  test-auto-scheduler - Run auto-scheduler tests"
	@echo "  test-vm-evaluator  - Run VM evaluator tests"
	@echo "  test-tensorir    - Run tensor IR tests"
...
test: test-benchmark test-cuda test-package test-debugger test-auto-scheduler test-vm-evaluator test-tensorir test-wasm test-attribute test-docgen
	@echo ""
...
test-tensorir:
	$(CXX) $(CXXFLAGS) -o test_tensorir $(TEST_TENSORIR_SOURCES)
	@./test_tensorir
