...
ifeq ($(CLAW_ENABLE_WEBTRANSPORT),1)
    COVERAGE_WEBTRANSPORT_FLAGS = -DCLAW_ENABLE_WEBTRANSPORT -I$(MSQUIC_PREFIX)/include
endif

$(COVERAGE_DIR)/%.o: %.cpp
	@mkdir -p $(dir $@)
	$(CXX) $(COVERAGE_FLAGS) -I. -Isrc -I$(LLVM_PREFIX)/include -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS $(COVERAGE_WEBTRANSPORT_FLAGS) -c -o $@ $<
