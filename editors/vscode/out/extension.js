...
function activate(context) {
    ...
    const clientOptions = {
        ...
        synchronize: {
            fileEvents: vscode_1.workspace.createFileSystemWatcher('**/*.claw')
        }
    };
    client = new node_1.LanguageClient('clawLanguageServer', 'Claw Language Server', serverOptions, clientOptions);
    client.start();
}
function deactivate() {
    if (!client) {
