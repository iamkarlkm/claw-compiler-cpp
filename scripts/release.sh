...
echo "  2. After GitHub generates the v$VERSION source tarball, update homebrew/claw.rb:"
echo "       curl -L -o v$VERSION.tar.gz https://github.com/iamkarlkm/claw-compiler-cpp/archive/refs/tags/v$VERSION.tar.gz"
echo "       shasum -a 256 v$VERSION.tar.gz"
